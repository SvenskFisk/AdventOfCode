...
namespace b
{
    class Program
    {
        ...
        {
            i = input.Split(',').Select(int.Parse).ToArray();
            var userInputs = new Queue<int>(new[] { 5 });
        ...
        static int p(int paramNumber)
        {
            var pows = new[] { 100, 1000, 10000 };
            var posMode = i[pos] / pows[paramNumber] % 10 == 0;
            return posMode ? i[i[pos + 1 + paramNumber]] : i[pos + 1 + paramNumber];
        }
    }
}
