...
namespace a
{
    class Program
    {
            ...
            while (true)
            {
                ...
                switch (instruction % 100)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        i[i[pos + 1]] = userInputs.Dequeue();
                        pos += 2;
                        break;
                    case 4:
                        Console.WriteLine(PosMode(instruction, 0) ? i[i[pos + 1]] : i[pos + 1]);
                        pos += 2;
                        break;
                    case 99:
                        return;
        ...
        static bool PosMode(int instruction, int paramNumber)
        {
            return instruction / (paramNumber == 0 ? 100 : 1000) % 10 == 0;
        }
    }
}
