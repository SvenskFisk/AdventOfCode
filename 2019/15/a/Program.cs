        ...
        switch (o)
        {
            ...
            case 1:
                return Enumerable.Range(1, 4)
                    ...
                    .Min();
            case 2:
                Console.WriteLine(moves.Select(x => x.ToString()).Aggregate((a, n) => a + "," + n));
                return moves.Length;
            default:
                throw new Exception();
        }
